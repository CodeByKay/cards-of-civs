      ...
      <Box sx={{ mb: 2 }}>
        <Paper elevation={1} sx={{ p: 2 }}>
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={12}>
              <Typography variant="subtitle1" align="center">[Age 1] Town Center (Player)</Typography>
              <Typography variant="body2" align="center">HP: 10000/10000</Typography>
            </Grid>
            <Grid item xs={12}>
              <Stack direction="row" spacing={3} justifyContent="center">
                <Typography variant="body2" sx={{ whiteSpace: 'nowrap' }}>Food: 200</Typography>
                <Typography variant="body2" sx={{ whiteSpace: 'nowrap' }}>Wood: 150</Typography>
                <Typography variant="body2" sx={{ whiteSpace: 'nowrap' }}>Gold: 100</Typography>
                <Typography variant="body2" sx={{ whiteSpace: 'nowrap' }}>Stone: 50</Typography>
              </Stack>
            </Grid>
          </Grid>
        </Paper>
